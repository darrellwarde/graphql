        ...
        test("Two relationships with nested operations specified on one", async () => {
            ...
            expect(printedSchema).toMatchInlineSnapshot(`
                ...
                type Movie {
                  ...
                  actorsConnection(after: String, first: Int, sort: [MovieActorsConnectionSort!], where: MovieActorsConnectionWhere): MovieActorsConnection!
                  id: ID
                  producers(limit: Int, offset: Int, options: PersonOptions @deprecated(reason: \\"Query options argument is deprecated, please use pagination arguments like limit, offset and sort instead.\\"), sort: [PersonSort!], where: PersonWhere): [Person!]!
    ...
    describe("Related to a union type", () => {
        test("Should not generate UpdateFieldInput input with no nested operations", async () => {
            ...
            expect(printedSchema).toMatchInlineSnapshot(`
                ...
                type Movie {
                  actors(limit: Int, offset: Int, options: QueryOptions @deprecated(reason: \\"Query options argument is deprecated, please use pagination arguments like limit, offset and sort instead.\\"), where: PersonWhere): [Person!]!
        ...
        test("Two relationships with nested operations specified on one", async () => {
            ...
            expect(printedSchema).toMatchInlineSnapshot(`
                ...
                type Movie {
                  ...
                  actorsConnection(after: String, first: Int, where: MovieActorsConnectionWhere): MovieActorsConnection!
                  id: ID
                  producers(limit: Int, offset: Int, options: QueryOptions @deprecated(reason: \\"Query options argument is deprecated, please use pagination arguments like limit, offset and sort instead.\\"), where: PersonWhere): [Person!]!
