...
describe("Authorization", () => {
    test("Authorization", async () => {
        ...
        expect(printedSchema).toMatchInlineSnapshot(`
            ...
            type Post {
              author(limit: Int, offset: Int, options: UserOptions @deprecated(reason: \\"Query options argument is deprecated, please use pagination arguments like limit, offset and sort instead.\\"), sort: [UserSort!], where: UserWhere): User!
            ...
            type User {
              id: ID!
              name: String!
              posts(limit: Int, offset: Int, options: UserOptions @deprecated(reason: \\"Query options argument is deprecated, please use pagination arguments like limit, offset and sort instead.\\"), sort: [UserSort!], where: UserWhere): [User!]!
