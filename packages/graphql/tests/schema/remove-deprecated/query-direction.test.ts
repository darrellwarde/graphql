...
describe("Query Direction", () => {
    test("DEFAULT_UNDIRECTED", async () => {
        ...
        expect(printedSchema).toMatchInlineSnapshot(`
            ...
            type User {
              friends(directed: Boolean = false @deprecated(reason: \\"The directed argument is deprecated, and the direction of the field will be configured in the GraphQL server\\"), limit: Int, offset: Int, sort: [UserSort!], where: UserWhere): [User!]!
