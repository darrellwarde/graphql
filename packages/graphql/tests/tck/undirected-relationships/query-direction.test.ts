...
describe("QueryDirection in relationships", () => {
    ...
    test("filter with a UNDIRECTED relationship", async () => {
        const query = /* GraphQL */ `
            query {
    ...
    test("disconnect with a UNDIRECTED relationship", async () => {
        const query = /* GraphQL */ `
            mutation {
                updateUsers(
    ...
    test("delete with a UNDIRECTED relationship", async () => {
        const query = /* GraphQL */ `
            mutation {
                updateUsers(
                    where: { friends_SOME: { name_EQ: "John Smith" } }
    ...
    test("update with a UNDIRECTED relationship", async () => {
        const query = /* GraphQL */ `
            mutation {
                updateUsers(
                    where: { friends_SOME: { name_EQ: "John Smith" } }
    ...
    test("nested delete with a UNDIRECTED relationship", async () => {
        const query = /* GraphQL */ `
            mutation {
                deleteUsers(
                    where: { friends_SOME: { name_EQ: "John Smith" } }
