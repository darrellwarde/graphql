...
export const writeConfigJson = ({ newAppDir, templateName, templateFileName }) => {
...
export const latestReleaseZipFile = async () => {
    const RELEASE_URL = "https://api.github.com/repos/grand-stack/grand-stack-starter/releases";
...
export const createProjectTasks = ({ newAppDir, rmTemplates, templateName, templateFileName, ...creds }) => {
    ...
    return [
        ...
        },
        {
            ...
            task: () => writeConfigJson({ newAppDir, templateName, templateFileName }),
        },
        {
